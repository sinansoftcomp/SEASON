				...
				<form name="searchFrm" id="searchFrm" method="get" action="<?$_SERVER['PHP_SELF']?>">
 				...
 				<input type="hidden" name="btn" id="btn" value="">
					<fieldset>
						...
						<div class="">
							<span  class="ser_font" style="font-size: larger;"> 정산월</span> 
							...
							<p class="response_block" style="margin-left:10px">
								...
								<input type="text" name="sname" id="sname" class="srch_css" style="height:26px;width:161px;margin-left:3px;border:1px solid" value="" placeholder="사원검색" onclick="skey_ser();" onkeyup="skey_chk();">
								<span class="btn_wrap">
									<a class="btn_s white hover_btn btn_search " style="width:140px;margin: 0px;" onclick="common_ser('A');">원수사 실적명세서</a>
									<a class="btn_s white hover_btn  " style="width:140px;margin: 0px;" onclick="common_ser_tot('B');">원수사별 조직실적</a>
									<a class="btn_s white hover_btn  " style="width:140px;margin: 0px;" onclick="common_ser_tot_tot('C');">원수사 실적집계표</a>
								</span>
							</p>
						</div>
					</fieldset>
					...
					<table class="gridhover">
						...
						<thead>
							<tr class="rowTop" style="height: 47px;">
								<th rowspan=2 align="center">원수사</th>
							</tr>
						</thead>							
						</tr>
...
$(document).ready(function(){	
	...
	//window.parent.postMessage("경영관리 > 원수사별 실적분석", "*");   // '*' on any domain 부모로 보내기..        
