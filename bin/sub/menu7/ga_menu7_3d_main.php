					...
					<fieldset>
						<div class="">
							...
							<p class="response_block" style="margin-left:10px">
								...
								<span class="btn_wrap">
									<a class="btn_s white hover_btn btn_search " style="width:140px;margin: 0px;" onclick="common_ser('A'); 	common_ser_3d_3('11'); ">조직별FC 3D산점도</a>
									<a class="btn_s white hover_btn  " style="width:140px;margin: 0px;" onclick="common_ser_tot('B');       	common_ser_3d_3('12'); ">조직별 원수사 3D산점도</a>
									<a class="btn_s white hover_btn  " style="width:140px;margin: 0px;" onclick="common_ser_tot_tot('C'); 	common_ser_3d_3('13'); ">조직별  3D산점도</a>
							</span>
							</p>
						</div>
					</fieldset>
...
function common_ser_3d_3(pbit){
		...
		var popOpen = window.open("<?=$conf['homeDir']?>/sub/menu7/ga_menu7_3d_dis.php?id=" + id + "&sdate1=" + sdate1 + "&sdate2=" + sdate2+ "&pbit=" + pbit,"width=" + screenWidth + ",height=" + screenHeight + ",top=0,left=0,status=0,toolbar=0,menubar=0,location=false,scrollbars=yes"	);
		popOpen.focus();
}
