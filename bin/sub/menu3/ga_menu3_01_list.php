...
<div class="tb_type01 kwndatalist div_grid" style="overflow-y:auto;">	
	<table id="sort_table" class="gridhover table_move" style="min-width: 3000px;">
		<colgroup>
			<col width="150px">
			<col width="100px">
			<col width="80px">
		...
		<tbody>
			...
			<tr class="rowData" rol-date='<?=$kcode?>' rol-date2='<?=$inscode?>'>
				...
				<td align="right" style="padding-right:5px;"><?=number_format($samt)?></td>
...
function startClick() {
    ...
    switch(numClicks) {
        case 2:
            ...
            break;
        case 1:
            timeOut = setTimeout("doSingle()", 1000);
            break;
    }
}
...
function documentMouseMove(ev){
	if($("#sort_table").hasClass("table_move") === true) {
