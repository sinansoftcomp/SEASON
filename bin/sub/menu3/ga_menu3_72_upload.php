...
<div class="popup_wrap" style="display:block" ><!-- popup 오픈시 html,body에 overflow:hidden --> 
	  <div class="popup_con" style="width:710px">
	  	...
	  	<h1 class="pop_tit" id="title_txt">수수료엑셀업로드</h1>
				...
				<div class="tb_type01 view">
					...
					<table>
						...
						<tr style="height:50px">
							...
							<td colspan=3>
								<b style="font-size: x-large;">수수료업로드</b>
							</td>
						</tr>
						<tr style="height:50px">
							<th><em class="impor">*</em>수수료정산년월</th>
							<td colspan=3>
								<span class="input_type date" style="width:100%"><input type="text" class="Cal_ym"  name="yymm"   id="yymm" value="" readonly></span> 
							</td>
						</tr>
...
function submitForm(frm) {
	...
	formData.append("yymm", yymm);			// 수수료정산년월 
