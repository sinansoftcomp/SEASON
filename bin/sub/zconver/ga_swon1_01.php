...
<div class="container">
	<div class="content_wrap">
		<fieldset>
			<legend>사원코드컨버전엑셀업로드</legend>
			<h2 class="tit_big">사원코드컨버전엑셀업로드</h2>

			<!-- 검색조건 -->
			<div class="tit_wrap mt20">
				<span>	
					시트자체 사원코드컨버전번호가 중복되면 수정건수와 디테일 건수가 중복된 DATA만큼 오차발생함
				</span>
				<span class="btn_wrap">
   			 	    <a href="#" class="btn_l white" style="min-width:100px;" onclick="upload();">사원코드컨버전엑셀업로드</a>
				</span>	  
...
// 상품관리 모달창
function upload(){
	$.ajaxLoding('ga_swon1_01_upload.php',$('.layerBody_item'),$('#modal2'));	
}
