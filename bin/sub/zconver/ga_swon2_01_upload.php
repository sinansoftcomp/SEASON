...
<div class="popup_wrap" style="display:block" ><!-- popup 오픈시 html,body에 overflow:hidden --> 
	  <div class="popup_con" style="width:750px">
	  	...
	  	<h1 class="pop_tit" id="title_txt">사원원수사코드(신코드)컨버전엑셀업로드</h1>
			...
			<div class="popup_con_in">
				<div class="tit_wrap" style="margin-top:0px">
					<h2 class="tit_sub">원수사 사원원수사코드(신코드)컨버전 업로드</h2>
					<span class="btn_wrap">
		...
		<fieldset>
			<div class="data_center" style="width:700px"  id="id_input" >
				<div class="tb_type01 view">
					<form name="excelupload_form" class="ajaxForm" method="post" action="ga_swon2_01_action.php" ENCTYPE="multipart/form-data">
					...
					<table>
						...
						<tr style="height:50px">
							...
							<td colspan=3>
								<b style="font-size: x-large;">사원원수사코드(신코드)컨버전료업로드</b>
							</td>
						</tr>
